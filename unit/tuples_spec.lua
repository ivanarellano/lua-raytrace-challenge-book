...
describe("Tuple", function ()
  ...
  it("Point:new() creates tuples with w=1", function ()
  ...
  it("Vector:new() creates tuples with w=0", function ()
  ...
  it("Subtracting a vector from a point", function ()
  ...
  it("Normalizing vector(4, 0, 0) gives (1, 0, 0)", function ()
